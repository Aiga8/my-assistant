...
- если команда про **исправление замечаний по итогам ревью тестов в TestRail** (кейсы в Design, назначенные на меня, замечания ревьювера в комментариях) → модуль `10-review-feedback-fixes`
...
## Флоу для модуля `10-review-feedback-fixes`
...
5) сохранить отчёт в `results/10-review-feedback-fixes/` (имя: `dd_mm_yy_section<SECTION_ID>_review_feedback.md`)
