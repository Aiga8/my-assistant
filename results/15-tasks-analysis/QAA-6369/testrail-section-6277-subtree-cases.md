...
Generated: 2026-03-12T07:14:24.549Z

- Root section: 6277 — Survey Spreadsheets
- Sections in subtree: 36
- Cases exported: 452
...
- 21223: Typewell
- 21295: Survey Program of typewell
- 21294: Magnetics of typewell
- 21293: Location Uncertainty of typewell
- 21226: Depth Reference of typewell
- 21225: Surface Location of typewell
- 21224: Typewell of typewell
- 7795: Well plan
- 8162: Survey Program
...
- 25188: Well of well
- 43132: Time Zone and Spud Date fields
...
- TR#406043 (section 37946): Trajectory tab does not duplicate when reopening via ribbon or object tree for same wellbore
...
- TR#314578 (section 6981): Send only changed attributes - Location Uncertainty field Vertical
- TR#425575 (section 6981): Send only changed attributes - Location Uncertainty field Horizontal
...
- TR#425758 (section 8152): Start MD in Survey Program is read-only
- TR#155840 (section 8152): Adding new rows
- TR#155835 (section 8152): Displaying Delete button for rows
- TR#425759 (section 8152): Editing Stop MD in Survey Program
...
- TR#155925 (section 8152): Toolcode default empty and options loaded from backend
- TR#155926 (section 8152): Selecting Toolcode via dropdown and saving
...
- TR#434539 (section 43132): Trajectory Sidebar. Time Zone and Spud Date fields are visible in Well section for wellbore
- TR#434540 (section 43132): Trajectory Ribbon. Time Zone and Spud Date fields are hidden in Well ribbon when flag is ON
- TR#434541 (section 43132): Trajectory Sidebar. Time Zone and Spud Date fields are NOT shown for typewell
- TR#434542 (section 43132): Trajectory Sidebar. Time Zone and Spud Date fields are NOT shown for well plan
- TR#434543 (section 43132): Trajectory Sidebar. Fields are enabled for user with canUpdateLateral permission
- TR#434544 (section 43132): Trajectory Sidebar. Fields are disabled with tooltip for user without canUpdateLateral (Viewer)
- TR#434545 (section 43132): Trajectory Sidebar. Time Zone dropdown shows list of UTC offsets
- TR#434546 (section 43132): Trajectory Sidebar. Time Zone value saves after selection from dropdown
- TR#434547 (section 43132): Trajectory Sidebar. Time Zone value can be changed to another
- TR#434548 (section 43132): Trajectory Sidebar. Time Zone manual input with Enter clears neither field
- TR#434549 (section 43132): Trajectory Sidebar. Spud Date accepts date earlier than first section start
- TR#434550 (section 43132): Trajectory Sidebar. Spud Date rejects date equal to or later than first section start
- TR#434551 (section 43132): Trajectory Sidebar. Spud Date max constraint equals first section start minus 1 minute
- TR#434552 (section 43132): Trajectory Sidebar. Spud Date reset button clears the field and sends PUT request
- TR#434553 (section 43132): Trajectory Sidebar. API request PUT spud-date contains project UUID in URL
- TR#434554 (section 43132): Trajectory Sidebar. Spud Date displays correctly with well time zone offset applied
- TR#434555 (section 43132): Trajectory Sidebar. Time Zone and Spud Date labels are shown in Spanish when locale is ES
- TR#434556 (section 43132): Trajectory Sidebar. Fields are accessible and visible on a public dashboard
- TR#434557 (section 43132): Feature flag OFF. Time Zone and Spud Date remain in ribbon, not shown in sidebar
- TR#434558 (section 43132): Trajectory Ribbon. Bit Projection and other elements intact when flag is ON (regression)
- TR#434559 (section 43132): Trajectory Sidebar. Spud Date field remains filled after page reload
- TR#434560 (section 43132): Trajectory Sidebar. Spud Date field is empty when Spud Date was never set
...
- TR#314529 (section 6757): Edit MD value and verify TVD recalculation
...
- TR#314532 (section 6757): Edit MD field with value exceeding 100000
- TR#426097 (section 6757): Edit MD field with negative value
- TR#314533 (section 6757): Edit INCL field with valid values
- TR#314534 (section 6757): Edit INCL field with boundary values
- TR#314535 (section 6757): Edit INCL field with value exceeding 180
- TR#426114 (section 6757): Edit INCL field with value less than 0
...
- TR#425680 (section 6757): Without Grid Convergence - AZIM GN is editable
