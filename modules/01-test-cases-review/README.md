...
```
Открой и строго следуй инструкциям: modules/01-test-cases-review/README.md
...
### 6. Метаданные и обязательные поля (TestRail)
- **Type:** у кейса должен быть тип **Regression** 
- **References:** в поле References указана **как минимум одна задача** (тикет Jira/другая ссылка)
- **Fix versions:** поле Fix version(s) **заполнено** (указана версия/релиз)
- **Заголовок:** заголовок теста (title) должен быть **на английском**
...
3. Создай/обнови отчетный файл в `results/01-test-cases-review/` в формате:
...
`C:\Users\a.suleimenova_rogii\Documents\my AI Assistant\my-assistant\results\01-test-cases-review`
