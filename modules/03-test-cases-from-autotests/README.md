...
```
Открой и строго следуй инструкциям: modules/03-test-cases-from-autotests/README.md
...
- Сначала формируешь и сохраняешь JSON в `results/03-test-cases-from-autotests/`
...
2) Сохрани JSON в `results/03-test-cases-from-autotests/` с именем:
...
1) Прочитай финальную версию JSON из `results/03-test-cases-from-autotests/`.
