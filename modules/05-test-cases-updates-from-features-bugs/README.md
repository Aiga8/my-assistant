...
```
Открой и строго следуй инструкциям: modules/05-test-cases-updates-from-features-bugs/README.md

Подготовь план обновления тестов в связи с задачей <>
TestRail: проект <5>, секция <15507> (и ее подсекций)
```
...
`results/05-test-cases-updates-from-features-bugs/`
...
- Не сохранять результат в другие папки (например, `13-demo-plan`); этот модуль имеет свою папку результатов.

---

## 4. Маршрутизация (для главного README)

- если команда про **обновление тестов TestRail на основе новой фичи или бага** (Jira-задача + секция/проект TestRail) → модуль `05-test-cases-updates-from-features-bugs`
