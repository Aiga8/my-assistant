 ...
 *   node modules/10-autotest-coverage/map_autotests_to_testrail.mjs --input <path-to-descriptions.md> --cases <path-to-testrail-export.json> [--out-base <base-path>]
 *
...
async function main() {
  ...
  const resultsDir = path.join("results", "10-autotest-coverage");
  ...
  if (!inMd || !inExport) {
    console.error("Usage: node modules/10-autotest-coverage/map_autotests_to_testrail.mjs --input <descriptions.md> --cases <testrail-export.json> [--out-base <path>]");
    process.exit(1);
  }
